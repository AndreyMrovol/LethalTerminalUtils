namespace TerminalUtils.Compatibility
{
	internal class LethalLibCompatibility : MrovLib.CompatibilityHandler
	{
		...
		{
			LethalLib.Modules.Unlockables.RegisteredUnlockable registeredUnlockable = LethalLib.Modules.Unlockables.registeredUnlockables.Find(
				x => x.unlockable == unlockable
			);
